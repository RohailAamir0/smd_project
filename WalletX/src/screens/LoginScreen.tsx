        ...
        >
          <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
            ...
            <View style={styles.header}>
              ...
              <Text style={styles.subtitle}>Sign in to your WalletX account</Text>
            </View>
...
function InputField({ label, icon, error, rightIcon, onRightIconPress, ...props }: InputFieldProps) {
  return (
    <View style={inputStyles.wrapper}>
      <Text style={inputStyles.label}>{label}</Text>
      <View style={[inputStyles.row, error && inputStyles.rowError]}>
        <MaterialCommunityIcons name={icon} size={20} color={Colors.textMuted} style={inputStyles.icon} />
        <TextInput
...
const styles = StyleSheet.create({
  ...
  forgotText: { color: Colors.accent1, fontSize: FontSize.sm, fontWeight: FontWeight.medium },
