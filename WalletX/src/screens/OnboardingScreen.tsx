...
const SLIDES: SlideData[] = [
  {
    ...
    subtitle: 'See every income and expense in one place. Know exactly where your money goes.',
  ...
  },
  {
    ...
    subtitle: 'Beautiful charts and category breakdowns help you understand your spending habits.',
  ...
  },
  {
    ...
    subtitle: 'Your financial data is encrypted and securely stored. Only you have access.',
...
function Slide({ slide }: { slide: SlideData }) {
  return (
    <View style={styles.slide}>
      ...
      >
        <MaterialCommunityIcons name={slide.icon} size={64} color={Colors.white} />
      </LinearGradient>
