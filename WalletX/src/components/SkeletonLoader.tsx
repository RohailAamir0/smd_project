      ...
      {Array.from({ length: count }).map((_, i) => (
        <View key={i} style={styles.row}>
          ...
          <View style={styles.lines}>
            <SkeletonBox width="60%" height={14} style={{ borderRadius: Radius.sm, marginBottom: 6 }} />
            <SkeletonBox width="40%" height={10} style={{ borderRadius: Radius.sm }} />
          </View>
          <SkeletonBox width={60} height={14} style={{ borderRadius: Radius.sm }} />
        </View>
      ))}
    </>
  );
